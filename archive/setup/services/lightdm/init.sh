...
sudo ln -s "$XDG_BIN_DIR"/services/lightdm/lightdm-gtk-greeter.conf /etc/lightdm/lightdm-gtk-greeter.conf
sudo cp "$XDG_BIN_DIR"/services/lightdm/wp.jpg /etc/lightdm/wp.jpg

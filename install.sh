...
main() {
  ...
  _task "Install git, ansible, python3-watchdog, zsh" ## TODO: watchdog used by beautiful-output, check if needed
  _cmd "sudo apt-get install -y git ansible python3-watchdog zsh"
